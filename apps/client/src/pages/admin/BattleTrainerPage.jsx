...
export default function BattleTrainerPage() {
    ...
    const prizePokemonPageEnd = prizePokemonTotal > 0
        ...
        : 0
    const autoGeneratedTrainerCount = trainers.filter((entry) => entry?.autoGenerated).length
            ...
            <div className="p-4">
                ...
                <div className="mt-6">
                    <div className="mb-2 flex items-center justify-between gap-2 flex-wrap">
                        <div className="text-sm font-bold text-slate-700">Danh sách trainer ({trainers.length})</div>
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                disabled={deletingAll || deletingAutoGenerated || loading || trainers.length === 0}
