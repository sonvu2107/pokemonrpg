                                            ...
                                            activeListings.map((listing) => (
                                                <tr key={listing.id} className="border-b border-blue-100 hover:bg-blue-50/40">
                                                    <td className="px-1 sm:px-3 py-2 sm:py-3 border-r border-blue-100 text-center">
                                                        ...
                                                        >
                                                            <img src={resolveImageSrc(listing.sprite || 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/0.png')} alt={listing.speciesName} className="w-10 h-10 sm:w-14 sm:h-14 object-contain pixelated mx-auto" />
                                                        </button>
                                                    </td>
