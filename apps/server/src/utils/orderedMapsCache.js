...
export const getOrderedMapsCached = async ({ forceRefresh = false } = {}) => {
    ...
    const maps = await MapModel.find({})
        .select('name slug levelMin levelMax isLegendary isEventMap iconId requiredSearches requiredPlayerLevel requiredVipLevel vipVisibilityLevel autoSearchRequiredVipLevel orderIndex')
