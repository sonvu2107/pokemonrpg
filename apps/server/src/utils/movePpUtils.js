...
export const mergeKnownMovesWithFallback = (moves = [], pokemonSpecies = null, level = 1) => {
...
export const syncUserPokemonMovesAndPp = async (userPokemon, { pokemonSpecies = null, level = null } = {}) => {
    if (!userPokemon) {
        return {
            moves: [],
            movePpState: [],
